...
const allSidebarItems = [
  ...
  { to: '/admin/categories', icon: FolderTree, label: 'Categorias', module: 'categories' },
  { to: '/admin/products', icon: Package, label: 'Produtos', module: 'products' },
  { to: '/admin/orders', icon: ShoppingCart, label: 'Pedidos', module: 'orders' },
  { to: '/admin/kds', icon: Monitor, label: 'KDS', module: 'kds' },
  { to: '/admin/customers', icon: Users, label: 'Clientes', module: 'customers' },
  { to: '/admin/delivery-zones', icon: MapPin, label: 'Zonas de Entrega', module: 'delivery' },
  { to: '/admin/coupons', icon: Ticket, label: 'Cupons', module: 'coupons' },
  { to: '/admin/loyalty', icon: Heart, label: 'Fidelidade', module: 'loyalty' },
  { to: '/admin/reports', icon: BarChart3, label: 'Relatorios', module: 'reports' },
  { to: '/admin/customization', icon: Palette, label: 'Personalizar', module: null },
  { to: '/admin/settings', icon: Settings, label: 'Configuracoes', module: null },
];
...
export default function AdminLayout() {
  ...
  const { user, tenantSlug, modules, plan } = useAppSelector((s) => s.adminAuth);
