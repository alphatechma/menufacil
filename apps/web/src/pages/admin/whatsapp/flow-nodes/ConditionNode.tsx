...
export function ConditionNode({ data, selected }: NodeProps) {
  ...
  const summary = field ? `${field} ${operator} ${value}` : 'Configurar...';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-xs font-semibold text-amber-700 uppercase">Condicao</span>
      </div>
      <p className="text-xs text-amber-800 truncate">{summary}</p>
