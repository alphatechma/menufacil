          ...
          <Card className="p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <Badge className={person.is_active ? 'bg-green-100 text-green-700' : 'bg-muted text-muted-foreground'}>
                ...
                {allOrders.map((order: any) => {
                  ...
                  return (
                    <Link
                      ...
                      className="flex items-center justify-between py-4 hover:bg-accent -mx-2 px-2 rounded-lg transition-colors"
                    >
