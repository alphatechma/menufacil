...
export default function OrderDetail() {
  ...
  const handleAdvanceStatus = async () => {
    ...
    // If ready -> out_for_delivery, open delivery person modal
        ...
        <div className="space-y-6">
              ...
              {Number(order.change_for) > 0 && (
                <div className="mt-3 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Cliente paga com</span>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Entregador</h2>
            </div>
            ...
            {activeDeliveryPersons.length === 0 ? (
              ...
              <>
                <select
                  className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                { key: 'out_for_delivery_at', label: 'Saiu p/ entrega' },
